...
-- Generated by ORDS REST Data Services 21.1.3.r1531102
-- Schema: EBIZAI  Date: Tue May 27 11:00:33 2025 
--
...
BEGIN
  ...
  ORDS.DEFINE_HANDLER(
      ...
      p_comments       => NULL,
      p_source         => 
'SELECT VC_MIME_TYPE, VC_PDF_DATA
FROM ebizai.VI_HD_VENDOR_INV
WHERE NU_LOG_ID=:ID');
  ...
  ORDS.DEFINE_HANDLER(
      ...
      p_comments       => NULL,
      p_source         => 
'SELECT VC_MIME_TYPE_GR, BL_PDF_GR_DATA              
FROM ebizai.HD_INVOICE_APP
WHERE NU_LOG_ID=:ID');
...
'SELECT VC_MIME_TYPE, VC_PDF_DATA
FROM ebizai.VI_HD_VENDOR_INV
WHERE VC_INVOICE_NO = :id
and vc_comp_code=:cd
AND DT_INVOICE_DATE=TO_DATE(:dt,''MM-DD-YY'')
AND NU_VENDOR_CODE = :qid');
  ...
  ORDS.DEFINE_PARAMETER(
      ...
      p_method             => 'GET',
      p_name               => 'id',
      p_bind_variable_name => 'invoice_no',
      p_source_type        => 'HEADER',
      p_param_type         => 'STRING',
      p_access_method      => 'IN',
      p_comments           => NULL);
  ...
  ORDS.DEFINE_PARAMETER(
      ...
      p_method             => 'GET',
      p_name               => 'cd',
      p_bind_variable_name => 'comp_code',
      p_source_type        => 'HEADER',
      p_param_type         => 'STRING',
      p_access_method      => 'IN',
      p_comments           => NULL);
  ...
  ORDS.DEFINE_PARAMETER(
      ...
      p_method             => 'GET',
      p_name               => 'qid',
      p_bind_variable_name => 'vendor_code',
      p_source_type        => 'HEADER',
      p_param_type         => 'STRING',
      p_access_method      => 'IN',
      p_comments           => NULL);
...
'select * from emp where empno = :id');
  ...
  ORDS.CREATE_ROLE(p_role_name => 'oracle.dbtools.role.autorest.EBIZAI');
    
  l_roles(1) := 'oracle.dbtools.autorest.any.schema';
  l_roles(2) := 'oracle.dbtools.role.autorest.EBIZAI';

  ORDS.DEFINE_PRIVILEGE(
      p_privilege_name => 'oracle.dbtools.autorest.privilege.EBIZAI',
      p_roles          => l_roles,
